...
public class ChatBotSwinng extends JFrame implements KeyListener
{
	JPanel p = new JPanel();
	...
	String chatBot[][] = {
			...
			//default
			{"you need sleep", "idk say else","stupid answer","la la la la" ,"Shut up nood!", }
